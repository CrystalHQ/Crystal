...
(function() {
  ...
  Contract.new = function() {
    if (this.currentProvider == null) {
      throw new Error("ReputationRegistry error: Please call setProvider() first before calling new().");
    }

    var args = Array.prototype.slice.call(arguments);

    if (!this.unlinked_binary) {
      throw new Error("ReputationRegistry error: contract binary not set. Can't deploy new instance.");
    }
    ...
    if (unlinked_libraries != null) {
      ...
      throw new Error("ReputationRegistry contains unresolved libraries. You must deploy and link the following libraries before you can deploy a new version of ReputationRegistry: " + unlinked_libraries);
    }
  ...
  Contract.at = function(address) {
    if (address == null || typeof address != "string" || address.length != 42) {
      throw new Error("Invalid address passed to ReputationRegistry.at(): " + address);
    }
  ...
  Contract.deployed = function() {
    if (!this.address) {
      throw new Error("Cannot find deployed address: ReputationRegistry not deployed or address not set.");
    }
    ...
    "abi": [
      ...
      },
      {
        ...
        "inputs": [
          ...
          {
            "name": "reputationTypesArgs",
            "type": "uint32"
          }
        ],
        "name": "Register_ContentType",
        "outputs": [],
        "type": "function"
      },
      {
  ...
  if (typeof module != "undefined" && typeof module.exports != "undefined") {
    ...
    // and we can use that.
    window.ReputationRegistry = Contract;
  }
})();
